...
def run(args=None):
    ...
    # Optimizer
    parser.add_option("--minibatch",dest="minibatch",type="int",default=25)
    ...
    parser.add_option("--middleDim",dest="middleDim",type="int",default=30)
...
def test(netFile,dataSet, model='RNN', trees=None):
    ...
    labels.sort()
    cm = confusion_matrix(correct,guess,labels)
